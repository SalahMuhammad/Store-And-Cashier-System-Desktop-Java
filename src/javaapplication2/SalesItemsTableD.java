...
public class SalesItemsTableD extends javax.swing.JDialog {

    public ItemsO itemsObject;
    
    public SalesItemsTableD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        new ItemsPanelMethods().displayForSales( jTable1, descText.getText() );
        
        MyMethods.createKeybindings( jTable1 );
        
        // tables text allignment
        MyMethods.jTableTextAlignment( jTable1, JLabel.CENTER );
        
        MyMethods.jTableHeaderRendererTextToCenter( jTable1 );
    }
    ...
    void action() {
        ...
        itemsObject = new ItemsO( 
            ...
            ( BigDecimal ) jTable1.getValueAt( s, 3 ),
            ( BigDecimal ) jTable1.getValueAt( s, 2 )
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesItemsTableD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SalesItemsTableD dialog = new SalesItemsTableD(new javax.swing.JFrame(), true);
